<%@ Page Title="" Language="C#" MasterPageFile="~/Stats.Master" AutoEventWireup="true" CodeBehind="Skema.aspx.cs" Inherits="FiberStat_Updated_V1.Skema" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
     <script type="text/javascript">
         ...
         function CC(text)
         {
            window.prompt("Kopier teksten: Ctrl+C, Enter", text);
         }
    </script>
            ...
            <asp:RadioButtonList ID="source" RepeatColumns="2" runat="server" Width="50%">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <label for="textarea1">Navn</label>
                    </div>
                </div>
        </div>
...
<label runat="server" style="font-size: 15px" id="label"></label>
    ...
    <div class="center-align">
        <asp:Button runat="server" ID="CopyButton" Text="Kopier og registrer" CssClass="waves-light waves-effect btn-large" OnClientClick="CC(document.getElementById('something').textContent)" Visible="false" />
    </div>
